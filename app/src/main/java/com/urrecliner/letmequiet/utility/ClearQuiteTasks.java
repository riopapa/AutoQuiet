...
public class ClearQuiteTasks {
    ...
    public ClearQuiteTasks() {
        ...
        quietTasks.add(new QuietTask(mContext.getString(R.string.WeekDay_Night), 22, 30, 6, 30, week, true, false, 1));

        week = new boolean[]{true, false, false, false, false, false, true};
        quietTasks.add(new QuietTask(mContext.getString(R.string.WeekEnd_Night), 23, 30, 9, 30, week, true, false, 1));

        week = new boolean[]{true, false, false, false, false, false, false};
        quietTasks.add(new QuietTask(mContext.getString(R.string.Sunday_Church), 9, 30, 16, 30, week, true, true, 0));
